 ...
 */
final class Version20231123091434 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, v_oiture_id INT DEFAULT NULL, client_id INT DEFAULT NULL, date_debut DATE NOT NULL, prix DOUBLE PRECISION NOT NULL, INDEX IDX_5E9E89CB2C53C18A (v_oiture_id), INDEX IDX_5E9E89CB19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE voiture (id INT AUTO_INCREMENT NOT NULL, serie INT NOT NULL, date_mise_circulation DATE DEFAULT NULL, modele VARCHAR(255) DEFAULT NULL, prix_jour DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
